...
biblio-style: C:/GoogleDrive/Literature/BibliographyStyles/trisocieties
vignette: >
...
mp_out <- mppop.predict(G.in = G.in_ex_imputed, y.in = y.in_ex, map.in = map.in_ex,
                        parents = sample_parents, n.parents = 4, model = "rrBLUP")
